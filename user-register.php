...
<!-- Mirrored from pixinvent.com/materialize-material-design-admin-template/html/ltr/vertical-modern-menu-template/user-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Sep 2021 11:27:54 GMT -->
<head>
    ...
    <form class="login-form">
      ...
      <div class="row margin">
        <div class="input-field col s12">
          ...
          <label for="password-again">Last Name</label>
        </div>
      </div>
      <div class="row margin">
        <div class="input-field col s12">
      ...
      <div class="row">
        <div class="input-field col s12">
          <a href="#" onclick="reguser();" class="btn waves-effect waves-light border-round gradient-45deg-purple-deep-orange col s12">Register</a>
        </div>
      </div>
      <div class="row">
        <div class="input-field col s12">
