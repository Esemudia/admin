            ...
            <form class="formValidate0" id="formValidate0" method="get">
              <div class="row">
                <div class="input-field col s12">
                  <label for="uname0">First Name*</label>
                  <input class="validate" required id="fname0" name="uname0" type="text">
                </div>

                <div class="input-field col s12">
                  <label for="uname0">Last Name *</label>
                  <input class="validate" required id="lname0" name="uname0" type="text">
                </div>
                <div class="input-field col s12">
                  <label for="cemail0">Phone Number *</label>
                  <input class="validate" required id="phone0" type="text" name="phone0">
                </div>
                <div class="input-field col s12">
                  <label for="uname0">E-mail *</label>
                ...
                <div class="input-field col s12">
                  <button class="btn waves-effect waves-light right" onclick="regAdmin(); return false;" type="submit" name="action">Submit
