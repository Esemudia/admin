                      ...
                      <div class="sidebar-content sidebar-chat">
                        <div class="chat-list">
                            ...
                            <?php
                                                   ...
                                                   if($_SESSION["usertype"]<7 ||$_SESSION["usertype"]=="0"){
                                                        ...
                                                        if($result!= null)
                                                            ...
                                                            $val=$rows;
                                                                    foreach($val as $key => $value)
                                                                    {
                                                                       ...
                                                                       $userid=$value["unique_id"];
                                                                       $log_in=$value["logged_in"];
                                                                       if($log_in==1){
                                                                        echo "
                                                                        <div class='chat-user animate fadeUp delay-2 active'  onclick= getBankname('\\".$bankname."'); return false;'>
                                                                        <p id='unique_id' style='display:none;'>".$userid."</p>
                                                                        <div class='user-section'> <div class='row valign-wrapper'>
                                                                              ...
                                                                              <img src='app-assets/images/user/7.jpg' alt=''
                                                                               ...
                                                                               <img src='app-assets/images/test.png'>
                                                                               <div class='col s10'>
                                                                                   <p class='m-0 blue-grey-text text-darken-4 font-weight-700' id='bankname'>".$value["BankName"]."</p>
                                                                        ...
                                                                        <div class='user-section'> <div class='row valign-wrapper'>
                                                                              ...
                                                                              <img src='app-assets/images/user/7.jpg' alt=''
                                                                               ...
                                                                               <img src='app-assets/images/offline.png'>
                                                                               <div class='col s10'>
                                                                                   <p class='m-0 blue-grey-text text-darken-4 font-weight-700' id='bankname'>".$value["BankName"]."</p>
                                                                                   <p class='m-0 info-text'>Apple pie bonbon cheesecake tiramisu</p>
                                                                                 </div>
